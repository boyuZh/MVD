...
do 
    for lan in CCPP #Python TypeScript Java CCPP JavaScript CS
    do
...
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
#SBATCH --err="_logs_linevul/bigvul_results_${lan}_seed${seed}.err"
#SBATCH --output="_logs_linevul/bigvul_results_${lan}_seed${seed}.out"
